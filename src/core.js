...
const COUNTRIES = [
  "Anywhere",
  // Americas
  "United States", "Canada", "Mexico", "Brazil", "Argentina", "Chile", "Colombia", "Peru", "Costa Rica",
  // Europe
  "United Kingdom", "Ireland", "Germany", "France", "Netherlands", "Belgium", "Spain", "Portugal", "Italy",
  "Switzerland", "Austria", "Sweden", "Norway", "Denmark", "Finland", "Poland", "Czech Republic", "Romania",
  "Hungary", "Greece", "Ukraine", "Estonia", "Lithuania", "Latvia",
  // Middle East & Africa
  "United Arab Emirates", "Saudi Arabia", "Qatar", "Kuwait", "Bahrain", "Oman", "Israel", "Turkey", "Egypt",
  "Nigeria", "Kenya", "South Africa", "Morocco",
  // Asia & Pacific
  "Pakistan", "India", "Bangladesh", "Sri Lanka", "China", "Hong Kong", "Japan", "South Korea", "Singapore",
  "Malaysia", "Indonesia", "Thailand", "Vietnam", "Philippines", "Australia", "New Zealand",
];
...
const CITY_SUGGESTIONS = {
  ...
  "United Kingdom": ["London", "Manchester", "Edinburgh", "Bristol", "Cambridge"],
  ...
  "Saudi Arabia": ["Riyadh", "Jeddah", "Dammam", "Khobar", "Mecca"],
  "Qatar": ["Doha", "Al Rayyan"],
  "Pakistan": ["Karachi", "Lahore", "Islamabad", "Rawalpindi", "Faisalabad"],
  "India": ["Bengaluru", "Mumbai", "Hyderabad", "Pune", "Delhi", "Chennai"],
  "Singapore": ["Singapore"],
